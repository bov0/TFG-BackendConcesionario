...
@cocheVendido.get("/coches/{id}", tags=["coches"], response_model=CocheBase, description="Ver coche por ID único")
...
@cocheVendido.post("/coches", tags=["coches"], response_model=CocheBase, description="Crear un nuevo coche")
...
@cocheVendido.put("/coches/{id}", tags=["coches"], response_model=dict, description="Modificar coche por ID")
...
@cocheVendido.delete("/coches/{id}", tags=["coches"], status_code=HTTP_204_NO_CONTENT)
...
@cocheVendido.get("/opcionesCajaCambios", tags=["enums"], response_model=List[str], description="Obtener opciones de caja de cambios")
def get_opciones_caja_cambios():
    return [caja.value for caja in CajaCambiosEnum]

@cocheVendido.get("/opcionesCombustible", tags=["enums"], response_model=List[str], description="Obtener opciones de combustible")
def get_opciones_combustible():
    return [combustible.value for combustible in CombustibleEnum]

@cocheVendido.get("/opcionesDistAmbiental", tags=["enums"], response_model=List[str], description="Obtener opciones de distancia ambiental")
def get_opciones_dist_ambiental():
    return [dist_ambiental.value for dist_ambiental in DistAmbientalEnum]

@cocheVendido.get("/opcionesTipoCarr", tags=["enums"], response_model=List[str], description="Obtener opciones de tipo de carrocería")
def get_opciones_tipo_carr():
    return [tipo_carr.value for tipo_carr in TipoCarrEnum]

@cocheVendido.get("/opcionesColor", tags=["enums"], response_model=List[str], description="Obtener opciones de color")
